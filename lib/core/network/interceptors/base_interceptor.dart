...
class BaseInterceptor extends Interceptor {
  ...
  void onRequest(
    ...
    options.headers.addAll({
      ...
      if (buildNumberValue != null && buildNumberValue.isNotEmpty) 'X-App-Version-Build-Number': buildNumberValue,
      if (platformValue != null && platformValue.isNotEmpty) 'X-App-Platform': platformValue,
      if (versionValue != null && versionValue.isNotEmpty) 'X-App-Version': versionValue,
    });
