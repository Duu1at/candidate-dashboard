...
import 'package:candidate_dashboard/core/di/storage_module.dart' as _i315;
import 'package:candidate_dashboard/core/storage/storage.dart' as _i75;
...
extension GetItInjectableX on _i174.GetIt {
  ...
  _i174.GetIt init({
    ...
    gh.lazySingleton<_i75.KVStore>(
      () => storageModule.candidatesKVStore(),
      instanceName: 'candidates_kv',
    );
    gh.lazySingleton<_i75.KVStore>(
      () => storageModule.statusesKVStore(),
      instanceName: 'statuses_kv',
    );
    ...
    gh.lazySingleton<_i846.LocalDatasource>(
      () => _i581.LocalDatasourceImpl(
        gh<_i712.KVStore>(instanceName: 'candidates_kv'),
        gh<_i712.KVStore>(instanceName: 'statuses_kv'),
      ),
    );
...
class _$StorageModule extends _i315.StorageModule {}
